...
parser.add_argument("-H","--host",help="host/sender's username",type=str,default=0)
parser.add_argument("-o",'--output',help='output file name',type=str,default=0)
parser.add_argument("--force",help="download and update existing file",type=bool,default=False)
